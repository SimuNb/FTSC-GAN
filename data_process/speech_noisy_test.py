...
def main():
    ...
    noisy_path = r"G:\paper_data\zhongwen\test_speech\noisy\new_demand_test"

    mix_npy_path = r"G:\paper_data\zhongwen\speech_noisy_0\test\mix"
    speech_npy_path = r"G:\paper_data\zhongwen\speech_noisy_0\test\speech"
    noisy_npy_path = r"G:\paper_data\zhongwen\speech_noisy_0\test\noisy"

    # speech_list = my_glob(speech_path_male)
    ...
    for item in all_people_list:
        ...
        while count < len(speech_list):
            ...
            for i in range(len(noisy_list)):
                ...
                full_speech_npy_path = speech_npy_path + "\\" + title + "_" + noisy_title + str(count) + "_speech.npy"
                # full_noisy_npy_path = noisy_npy_path + "\\" + title + "_" + noisy_title + str(count) + "_noisy.npy"
                full_mix_npy_path = mix_npy_path + "\\" + title + "_" + noisy_title + str(count) + "_mix.npy"
